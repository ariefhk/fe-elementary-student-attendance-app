    ...
    <div className="hidden  font-poppins  h-full bg-white md:block">
      <div className="flex h-full max-h-screen flex-col ">
        ...
        <div className="flex-1  overflow-y-auto py-5 border-r-[1px] border-black/20">
          <nav className="grid  gap-y-4 items-start  text-sm font-medium px-3">
                ...
                return (
                  <div key={index + 1} className="space-y-5 ">
                    <Link
                      ...
                      className={cn(
                        "flex items-center rounded-[6px] px-4 justify-between group/item hover:bg-color-1  h-[45px] transition-all hover:text-primary ",
                        {
                      ...
                      <div className="flex items-center gap-3 ">
                        <DashIcon
                          className={cn(
                            "w-6 h-6 flex-shrink-0 text-black group-hover/item:text-white",
                            {
